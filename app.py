...
def predict():
    ...
    prediction2 = model1.predict(final_features)
    prediction3 = model1.predict(final_features)
    ...
    return render_template('index.html', output1=output1,output2=output2,output3=output3,detail1=detail1, detail2=detail2,detail3=detail3,detail4=detail4, detail5=detail5,detail6=detail6)
